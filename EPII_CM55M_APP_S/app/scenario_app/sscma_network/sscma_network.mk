...
##
LIB_SEL = pwrmgmt tflmtag2209_u55tag2205 spi_eeprom sensordp sscma_micro cmbacktrace
##
...
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/sscma_network.sct
else#TOOLChain
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/sscma_network.ld
endif
...
LIB_SSCMA_MICRO_DEFINES = -DLIB_SSCMA_MICRO -DCONFIG_EL_TARGET_HIMAX -DCONFIG_EL_BOARD_SENSECAP_WATCHER 
