...
/* Face Recognition JSON output (for Web Debug Tool) */
...
void send_face_recognition_json(
    el_img_t* jpeg_img,           /* JPEG image (optional, NULL to skip) */
    el_box_t* face_box,           /* Face bounding box */
    const float* embedding,       /* Embedding array (must be 4-byte aligned!) */
    int embedding_dim,            /* 512 */
    const float* landmarks,       /* 5-point landmarks (10 floats: x1,y1,x2,y2,...) */
    float confidence,             /* Detection confidence */
    const uint8_t* aligned_face,  /* Aligned face RGB image (optional, NULL to skip) */
    int aligned_w,                /* Aligned face width (112) */
    int aligned_h                 /* Aligned face height (112) */
);